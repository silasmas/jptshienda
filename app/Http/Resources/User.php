...
class User extends JsonResource
{
    ...
    {
        $roles_user = RoleUser::collection($this->role_users)->sortByDesc('created_at')->toArray();
        ...
        return [
            ...
            'avatar_url' => !empty($this->avatar_url) ? 'https://api.jptshienda.cd/public/storage/' . $this->avatar_url : null,
            // 'avatar_url' => !empty($this->avatar_url) ? 'https://jptshienda.dev:1443/storage/' . $this->avatar_url : null,
